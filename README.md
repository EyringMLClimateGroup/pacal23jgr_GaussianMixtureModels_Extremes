...
This repository uses Python 3.8. You can use this repository with ESMValTool python environment. The required packages are listed in `environment.yaml`. To install the required packages, run the following command:
